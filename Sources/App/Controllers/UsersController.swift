...
struct UsersController: RouteCollection {
    ...
    func updateHandler(_ req: Request, updatedUser: User) throws -> Future<User> {
        return try req.parameter(User.self).flatMap(to: User.self) { user in
